...
const Favourite = ({ navigation }) => {
  ...
  const [myBookmarkEstates, setMyBookmarkEstates] = useState(initialBookmarkEstates || []);
  ...
  /**
     * Render my bookmark estates
     */
  const renderMyBookmarkEstates = () => {
    const [selectedCategories, setSelectedCategories] = useState(["1"]);

    const filteredEstates = myBookmarkEstates.filter(estate => selectedCategories.includes("1") || selectedCategories.includes(estate.categoryId));
